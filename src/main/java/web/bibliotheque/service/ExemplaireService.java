...
public class ExemplaireService {
    ...
    // public Pret autoriserAPreter(PretExemplaireDTO pretExemplaireDTO) throws
    // Exception {
    // Optional<Exemplaire> exemplaireOpt =
    // this.getByRef(pretExemplaireDTO.getRef());
    // if (exemplaireOpt.isPresent()) {
    // Exemplaire exemplaire = exemplaireOpt.get();
    // if (this.estDisponible(pretExemplaireDTO.getDateDePret(),
